...
class AnimalActions:
    def quack(self): return self._do_action('quack')
    def feathers(self): return self._do_action('feathers')
    def bark(self): return self._do_action('bark')
    def fur(self): return self._do_action('fur')
